...
namespace SweetTest
{
    ...
    {
        [TestCase(10, 20,
            TestName = "(Позитивный) Максимальные параметры консруктора цилиндрической конфеты")]
        [TestCase(25, 50,
            TestName = "(Позитивный) Минимальные параметры консруктора цилиндрической конфеты")]
        [TestCase(17.5, 35,
            TestName = "(Позитивный) Средние параметры консруктора цилиндрической конфеты")]
        [Test]
