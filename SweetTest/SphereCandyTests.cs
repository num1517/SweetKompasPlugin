...
{
    [TestFixture]
    class SphereCandyTests
    {
        [TestCase(10,
            TestName = "(Позитивный) Максимальные параметры консруктора сферической конфеты")]
        [TestCase(25,
            TestName = "(Позитивный) Минимальные параметры консруктора сферической конфеты")]
        [TestCase(17.5,
            TestName = "(Позитивный) Средние параметры консруктора сферической конфеты")]
        [Test]
