...
{
    [TestFixture]
    class RectCandyTests
    {
        [TestCase(50, 30, 50,
            TestName = "(Позитивный) Максимальные параметры консруктора квадратной конфеты")]
        [TestCase(20, 15, 20,
            TestName = "(Позитивный) Минимальные параметры консруктора квадратной конфеты")]
        [TestCase(35, 22.5, 35,
            TestName = "(Позитивный) Средние параметры консруктора квадратной конфеты")]
        [Test]
